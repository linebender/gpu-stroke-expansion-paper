...
if do_test_scenes:
	arcs = pd.DataFrame({
		...
		"mmark-70k (arcs)": [7.50, 0.943, 1.67, 0.13434],
		"mmark-120k (arcs)": [13.17, 1.54, 2.38, 0.19562]
		}, index=["Mali-G78", "M1 Max", "GTX 980Ti", "RTX 4090"]
	)
	lines = pd.DataFrame({
		"long dash (lines)": [13.06, 3.11, 1.35, 0.31733],
		"mmark-70k (lines)": [12.45, 1.73, 2.95, 0.22960],
		"mmark-120k (lines)": [22.52, 2.87, 4.34, 0.38593],
		}, index=["Mali-G78", "M1 Max", "GTX 980Ti", "RTX 4090"]
	)
else:
	arcs = pd.DataFrame({
