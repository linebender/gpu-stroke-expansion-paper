...
\begin{table}
    ...
    \hline
        ...
        mmark-70k  & 23.81 MB  & 100.79   \\
        mmark-120k & 40.86 MB  & 173.56   \\
    \hline
    \end{tabular}
...
\begin{itemize}
    ...
    \item The pre-allocation requirement for bump-allocated line soup buffer is a limitation due to today's graphics APIs. A more accurate and optimized buffer size estimation heuristic is considered future work. Another interesting future exploration is to employ newer GPU API features, such as mesh shaders and work graphs, for GPU-driven scheduling of the compute workload under a bounded memory footprint.
