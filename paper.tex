...
\begin{figure}
    \includegraphics[scale=0.5]{question}
    \caption{Subdivision of a cubic Bézier with a cusp into continuous Euler spiral segments.}
    \Description{A cubic Bézier with a cusp is approximated by Euler spiral segments with finite curvature, including one with a question mark shape.}
